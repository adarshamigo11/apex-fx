...
export const DEFAULT_SYMBOLS: (SymbolSpec & {
  displayName: string; source: 'binance' | 'twelvedata' | 'fcsapi' | 'mock'; externalSymbol: string;
})[] = [
  { name: 'XAUUSD', displayName: 'Gold',     kind: 'METAL',  base: 'XAU', quote: 'USD', contractSize: 100,    digits: 2, spreadPoints: 30, commission: 0, source: 'fcsapi', externalSymbol: 'XAUUSD' },
  { name: 'EURUSD', displayName: 'Euro',     kind: 'FOREX',  base: 'EUR', quote: 'USD', contractSize: 100000, digits: 5, spreadPoints: 8,  commission: 0, source: 'fcsapi', externalSymbol: 'EURUSD' },
  { name: 'GBPUSD', displayName: 'Pound',    kind: 'FOREX',  base: 'GBP', quote: 'USD', contractSize: 100000, digits: 5, spreadPoints: 12, commission: 0, source: 'fcsapi', externalSymbol: 'GBPUSD' },
  { name: 'USDJPY', displayName: 'Yen',      kind: 'FOREX',  base: 'USD', quote: 'JPY', contractSize: 100000, digits: 3, spreadPoints: 10, commission: 0, source: 'fcsapi', externalSymbol: 'USDJPY' },
